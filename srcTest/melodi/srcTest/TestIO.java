...
//		LinkedList<Unit> toTest = mig_parent.chain_SE;
//		Unit mySE = toTest.get(0);
//
...
//		Assert.assertEquals("Abattoir.html", name);
//
//		LinkedList<Unit> chain_newMIG_SE = newMIG.chain_SE;
//		Unit toTest = chain_newMIG_SE.get(indexSE);
//
